...
var $mapWrap=$("#mapWrap");window.$mapWrap=$mapWrap;var $searchSort=$("#searchSort");window.$searchSort=$searchSort;bmapInit();$("body").on("tap",".iconBack",function(a){a.stopPropagation();
...
$("body").on("tap","#chooseKmButton",function(){if(!flag){$(this).parents(".chooseDistance").children(".chooseKm").show();flag=true;}else{$(this).parents(".chooseDistance").children(".chooseKm").hide();
...
}};$("body").on("tap","#chooseKm span",function(){var b=$(this).text();var a=$(this).attr("data");$("#kmsum").text(b).attr("data",a);$(this).parent("#chooseKm").hide();
initSearch();flag=false;});function initSearch(){var b=$("#mapSearchText").val();var a="r-result";var c=$("#kmsum").attr("data");searchFun(b,a,c);}$("body").on("tap","#searchSort > span",function(){$(this).addClass("current").siblings().removeClass("current");
...
var k=$("#traceList");if(k.length>=1){k.remove();}$mapWrap.append(l);}else{alert("您选择地址没有解析到结果!");}},"上海市");}$("body").on("tap","#showDetailList",function(){$("#r-result").parents(".resultWrap").show().animate({left:"0"});
});$("body").on("tap","#r-result li",function(){var c="超市";var a="大道";var e="1km";var d="";d+='<div class="searchListHead"><span class="iconfont icon-jiantouBack iconBack"></span><div class="headlist" id="head-searchThumb"><span class="headName">'+c+'</span><span class="headAddress">'+a+'</span><span class="headtance"><span class="iconfont icon-iconfontluxiandaohang"></span> <label class="headDistance">'+e+"</label></span></div></div>";
...
}$("#searchThumblist").html(g);});});$("body").on("tap","#searchThumblist a",function(){var f=$(this).find(".thumbimg").attr("src");var a=$(this).find(".thumbname").text();
...
$("#searchThumblistBox").html(g);});$("body").on("tap","#headList li",function(){var b=$(this).children(".iconfont");var c=$(this);var a=$(this).parents(".resultWrap");
...
$("body").on("tap","#categoriesList > span",function(){$(this).addClass("current").siblings().removeClass("current");});