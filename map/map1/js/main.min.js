...
require.config({baseUrl:"./",paths:{zepto:"js/zepto.min",text:"js/requirejs/plugins/text",json:"js/requirejs/plugins/json",async:"js/requirejs/plugins/async",BMap:"https://api.map.baidu.com/api?v=2.0&ak=eM1XK6ESgAmeTi6WrMSZeXVd"}});
