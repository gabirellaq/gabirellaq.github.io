...
// 云基
// 信息发布平台
var Infoplat = { template: '#infoplatpage' }
// 系统配置平台
var Config = { template: '#configpage'}
// 基础组件平台
var Coral = { template: '#coralpage'}
// 全文检索平台
var Search = { template: '#searchpage'}
// 系统管理平台
var Authsystem = { template: '#authsystempage'}
// 工作流平台
var Workflow = { template: '#workflowpage'}

// 灵器
// 电子文件通用浏览器
var BrowserTool = {template: '#browsertoolpage'};
// 电子文件封装工具
var PackageTool = {template: '#packagetoolpage'};
// 电子文件格式转换软件
var ConvertTool = {template: '#converttoolpage'};
// 电子文件检测软件
var CheckTool = {template: '#checktoolpage'};
// 电子文件离线浏览软件
// var OfflineTool = {template: '#offlinetoolpage'};

// 关于我们
// 中心概述
var CenterInfo = {template: '#centerinfopage'};
// 组织沿革
var OrganizeHistory = {template: '#organizehistorypage'};
// 组织定位
var OrganizeOrientation = {template: '#organizeorientationpage'};
// 中心文化
var CenterCulture = {template: '#centerculturepage'};
